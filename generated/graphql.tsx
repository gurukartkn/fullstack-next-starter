...
export type LoginMutation = { __typename?: 'Mutation', login?: { __typename?: 'LoginResponse', email?: string | null, username?: string | null } | null };

export type ImplicitLoginQueryVariables = Exact<{ [key: string]: never; }>;


export type ImplicitLoginQuery = { __typename?: 'Query', implicitLogin?: { __typename?: 'implicitLoginResponse', loggedIn: boolean, email?: string | null } | null };
