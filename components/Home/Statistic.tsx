...
export const Statistic: NextComponentType = () => {
  return (
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="text-center">
          <div className="flex items-center justify-center w-10 h-10 mx-auto mb-3 rounded-full bg-indigo-50 sm:w-12 sm:h-12">
            <svg
              className="w-8 h-8 text-purple-500 sm:w-10 sm:h-10"
              stroke="currentColor"
              viewBox="0 0 52 52"
            >
              <polygon
          ...
          <h6 className="text-4xl font-bold text-purple-500">819</h6>
        ...
        <div className="text-center">
          ...
          <h6 className="text-4xl font-bold text-purple-500">1.3K</h6>
        ...
        <div className="text-center">
          ...
          <h6 className="text-4xl font-bold text-purple-500">91</h6>
        ...
        <div className="text-center">
          ...
          <h6 className="text-4xl font-bold text-purple-500">52</h6>
