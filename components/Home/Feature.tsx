        ...
        <div>
          ...
          <ul className="mb-4 -ml-1 space-y-2">
            <li className="flex items-start">
              <span className="mr-1">
                <svg
                  className="w-5 h-5 mt-px text-purple-500"
                  stroke="currentColor"
                  viewBox="0 0 52 52"
                >
                  <polygon
          ...
          <Link href="/" aria-label="">
            <button className="inline-flex items-center font-semibold transition-colors duration-200 text-purple-500 hover:text-purple-800">
              Learn more
            </button>
          </Link>
        </div>
